...
Puedes probar a mover el robot para ver cómo cambian las lecturas. **En una terminal en el PC** lanza el `roslaunch turtlebot_teleop keyboard_teleop.launch`. Recuerda que esta ventana tiene que tener el foco del teclado para que funcione.
